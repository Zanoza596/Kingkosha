...
class UnitsCategories(models.Model):
    name = models.CharField(
        max_length=150, blank=True, null=True, verbose_name="Название"
    )
    # Units=models.PositiveIntegerField()
    note = models.TextField(
        max_length=200, blank=True, null=True, verbose_name="Примечания"
    )
...
class Units(models.Model):
    ...
    unitCategory = models.ForeignKey(
        to=UnitsCategories,
        null=True,
        verbose_name="Категория единицы",
...
class Sources(models.Model):  # источники сырья и комплектующих
    ...
    mapChart = models.ImageField(
        upload_to="main_images", blank=True, null=True, verbose_name="Чертёж"
    )
    mapSketch = models.ImageField(
        upload_to="main_images", blank=True, null=True, verbose_name="Эскиз"
    )
    mapDemonstrableForm = models.ImageField(
        upload_to="main_images",
        blank=True,
        null=True,
        verbose_name="Наглядное отображение",
    )
    photo = models.ImageField(
        upload_to="main_images", blank=True, null=True, verbose_name="Фото"
    )
...
class Equipments(models.Model):
    ...
    equipmentCategory = models.ForeignKey(
        to=EquipmentsCategories,
        null=True,
        verbose_name="Категория проекта",
        on_delete=models.CASCADE,
    )
    source = models.ForeignKey(
        to=Sources, null=True, verbose_name="Источник", on_delete=models.CASCADE
    )
    ...
    demonstrableForm = models.ImageField(
        upload_to="main_images",
        blank=True,
        null=True,
        verbose_name="Наглядное отображение",
...
class Amortizations(models.Model):
    equipment = models.ForeignKey(
        to=Equipments, null=True, verbose_name="Источник", on_delete=models.CASCADE
    )
    # Operations=models.PositiveIntegerField()
    note = models.TextField(
        max_length=200, blank=True, null=True, verbose_name="Примечания"
...
class ComponentsTechCategories(models.Model):
    ...
    parent = models.ForeignKey(
        to="self", null=True, verbose_name="Источник", on_delete=models.CASCADE
    )  # Отображает множество сущностей ComponentTechCategorys на себя
    note = models.TextField(
        max_length=200, blank=True, null=True, verbose_name="Примечания"
    )
    slug = models.SlugField(
...
class ComponentsProjCategories(models.Model):
    ...
    parent = models.ForeignKey(
        ...
        on_delete=models.CASCADE,
    )  # Отображает множество сущностей ComponentProjCategorys на себя
    note = models.TextField(
        max_length=200, blank=True, null=True, verbose_name="Примечания"
    )
    slug = models.SlugField(
...
class ComponentsGoals(models.Model):
    ...
    parent = models.ForeignKey(
        to="self", null=True, verbose_name="Источник", on_delete=models.CASCADE
    )  # Отображает множество сущностей ComponentGoals на себя
    note = models.TextField(
        max_length=200, blank=True, null=True, verbose_name="Примечания"
    )
    slug = models.SlugField(
...
class Components(models.Model):
    ...
    componentTechCategory = models.ForeignKey(
        to=ComponentsTechCategories,
        null=True,
        verbose_name="Техническая категория",
        on_delete=models.CASCADE,
    )
    componentProjCategory = models.ForeignKey(
        to=ComponentsProjCategories,
        null=True,
        verbose_name="Проектная категория",
        on_delete=models.CASCADE,
    )
    componentGoal = models.ForeignKey(
        to=ComponentsGoals,
        null=True,
        default=1,
        verbose_name="Цель",
    ...
    owners = models.ManyToManyField(
        to="Components",
        through="ComponentsComponents",
        through_fields=("ownerComponent", "partComponent"),
        verbose_name="Владелец",
    )  # Отображает множество сущностей Components на себя(владельцы)
    source = models.ForeignKey(
        to=Sources, null=True, verbose_name="Источник", on_delete=models.CASCADE
    )
    chart = models.ImageField(
    ...
    sketch = models.ImageField(
        upload_to="proj_images", blank=True, null=True, verbose_name="Эскиз"
    )  #
    photo = models.ImageField(
        upload_to="main_images", blank=True, null=True, verbose_name="Фото"
    )
    ...
    componentsOperations = models.ManyToManyField(
        to="Operations",
    ...
    unit = models.ForeignKey(
        to=Units, null=True, verbose_name="Оценочная единица", on_delete=models.CASCADE
    )
    ...
    price = models.DecimalField(
        default=0.00, max_digits=7, decimal_places=2, verbose_name="Стоимость единицы"
    )
    discount = models.DecimalField(
        default=0.00, max_digits=4, decimal_places=2, verbose_name="Скидка в %"
    )
    selfCost = models.DecimalField(
        default=0.00, max_digits=7, decimal_places=2, verbose_name="Себестоимость"
    )
...
class ComponentsComponents(models.Model):
    ...
    ownerComponent = models.ForeignKey(
        to=Components,
        null=True,
        related_name="parts",
    ...
    partComponent = models.ForeignKey(
        to=Components,
        null=True,
        related_name="assembles",
        verbose_name="Источник",
        on_delete=models.CASCADE,
    )
    quantity = models.DecimalField(
        default=1.00, max_digits=7, decimal_places=2, verbose_name="Количество"
    )
...
class Projects(models.Model):
    ...
    finishDateTame = models.DateTimeField(blank=True, null=True)
    price = models.DecimalField(
        default=0.00, max_digits=7, decimal_places=2, verbose_name="Стоимость"
    )
    discount = models.DecimalField(
        default=0.00, max_digits=4, decimal_places=2, verbose_name="Скидка в %"
    )
...
class Operations(models.Model):
    ...
    unit = models.ForeignKey(
        to=Units, null=True, verbose_name="Елиница", on_delete=models.CASCADE
    )
    cost = models.DecimalField(
        default=0.00, max_digits=7, decimal_places=2, verbose_name="Стоимость"
    )
    category = models.ForeignKey(
        to=OperationsCategories,
        null=True,
        verbose_name="Категория операции",
        on_delete=models.CASCADE,
    )
    equipment = models.ForeignKey(
        to=Equipments, null=True, verbose_name="Оборудование", on_delete=models.CASCADE
    )
    ...
    salary = models.DecimalField(
        default=0.00, max_digits=7, decimal_places=2, verbose_name="Зарплата"
    )
    ...
    amortization = models.ForeignKey(
        to=Amortizations, null=True, verbose_name="Елиница", on_delete=models.CASCADE
    )
    # Works=models.PositiveIntegerField()
    note = models.TextField(
        max_length=200, blank=True, null=True, verbose_name="Примечания"
...
class ComponentsOperations(models.Model):  # связь многие ко многим
    component = models.ForeignKey(
        to=Components, null=True, verbose_name="Материал", on_delete=models.CASCADE
    )
    operation = models.ForeignKey(
        to=Operations, null=True, verbose_name="Операция", on_delete=models.CASCADE
    )
    quantity = models.DecimalField(
        default=1.00, max_digits=7, decimal_places=2, verbose_name="Количество"
    )
...
class ProjectsOperations(models.Model):  # связь многие ко многим
    project = models.ForeignKey(
        to=Projects, null=True, verbose_name="Материал", on_delete=models.CASCADE
    )
    operation = models.ForeignKey(
        to=Operations, null=True, verbose_name="Операция", on_delete=models.CASCADE
    )
    operationStatus = models.ForeignKey(
        to=OperationsStatuses,
        null=True,
        verbose_name="Операция",
        on_delete=models.CASCADE,
    )
...
class Works(models.Model):
    ...
    finishtDateTimeOperation = models.DateTimeField(
        null=True
    )  # если null - операция не завершена
    workTime = models.TimeField(blank=True, null=True)
    worker = models.ForeignKey(
        to=Workers, null=True, verbose_name="Сотрудник", on_delete=models.CASCADE
    )
    project = models.ForeignKey(
        to=Projects, null=True, verbose_name="Проект", on_delete=models.CASCADE
    )
    operation = models.ForeignKey(
        to=Operations, null=True, verbose_name="Операция", on_delete=models.CASCADE
    )
    makeWork = models.DecimalField(
        default=0.00, max_digits=7, decimal_places=2, verbose_name="Сделано работы,с"
    )
    note = models.TextField(
        max_length=200, blank=True, null=True, verbose_name="Примечания"
    )
...
class Storage(models.Model):
    ...
    quantity = models.DecimalField(
        default=0.00, max_digits=7, decimal_places=2, verbose_name="Количество"
    )
    note = models.TextField(
        max_length=200, blank=True, null=True, verbose_name="Примечания"
    )
