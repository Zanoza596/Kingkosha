...
from main.models import Components, Projects
...
class OrderItem(models.Model):
    ...
    product = models.ForeignKey(to=Components, on_delete=models.SET_DEFAULT, null=True, verbose_name="Продукт", default=None)
